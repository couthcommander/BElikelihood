...
####### for 2x4 design
p4a <- proLikelihood(dat, colSpec = cols, xlength = 50, method = 'average')
plot(p4a)
...
p3a <- proLikelihood(dd3, colSpec = cols, xlength = 50, method = 'average')
plot(p3a)

###### for 2x2 design
dd2 <- dat[dat$period < 3,]
p2a <- proLikelihood(dd2, colSpec = cols, xlength = 50, method = 'average')
plot(p2a)
```
...
####### for 2x4 design
p4t <- proLikelihood(dat, colSpec = cols, xlength = 50, method = 'total')
plot(p4t)
...
####### for 2x2 design
p2t <- proLikelihood(dd2, colSpec = cols, xlength = 50, method = 'total')
plot(p2t)
```
...
####### for 2x4 design
p4w <- proLikelihood(dat, colSpec = cols, xlength = 50, method = 'within')
plot(p4w)
...
####### for 2x3 design
p3w <- proLikelihood(dd3, colSpec = cols, xlength = 50, method = 'within')
plot(p3w)
```
